...
@Configuration
@ComponentScan(basePackages = { "com.portfolio.carrental.service" }, includeFilters = @Filter({ Controller.class, Service.class }), useDefaultFilters = false)
@EnableAspectJAutoProxy
@EnableTransactionManagement
@MapperScan(basePackages = { "com.portfolio.carrental.mappers" })
