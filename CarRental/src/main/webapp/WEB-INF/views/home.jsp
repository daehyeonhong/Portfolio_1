...
<link rel="stylesheet"
	href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0//resources/css/font-awesome.min.css">
...
<body>
		...
		<div class="container">
			<div
				...
				<div class="col-md-4 d-flex mb-2 mb-md-0">
					<a class="navbar-brand d-flex align-items-center" href="index.html"><span
						class="flaticon flaticon-road-roller"></span><span>Equipo <small>Rental
								Heavy Equipment</small></span></a>
				</div>
				...
				<div class="col-md-4 d-flex topper mb-md-0 align-items-center">
					...
					<div class="text pl-3 pl-md-3">
						...
						<p class="con">198 West 21th Street, Suite 721 New York NY
							10016</p>
					</div>
				</div>
			</div>
		...
		<div class="container d-flex align-items-center">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav m-auto">
					...
					<li class="nav-item"><a href="services.html" class="nav-link">Rental
							Services</a></li>
					<li class="nav-item"><a href="gallery.html" class="nav-link">Gallery</a></li>
					<li class="nav-item"><a href="blog.html" class="nav-link">Blog</a></li>
					<li class="nav-item"><a href="contact.html" class="nav-link">Contact</a></li>
					<li class="nav-item cta"><a href="contact.html"
						class="nav-link">Request A Quote</a></li>
				</ul>
			</div>
		</div>
	</nav>
			...
			<div
				...
				<div class="col-lg-9 ftco-animate text-center">
					<div class="mt-5">
						...
						<p>
							<a href="#" class="btn btn-primary">Contact us</a> <a href="#"
								class="btn btn-white">Request A Quote</a>
						</p>
					</div>
				</div>
			</div>
	...
	<section
		class="ftco-section ftco-no-pt ftco-no-pb ftco-services-2 bg-primary">
		<div class="container">
						...
						<div class="row">
							...
							<div
								...
								<div class="media block-6 services d-flex">
									<div
										class="icon justify-content-center align-items-center d-flex">
										<span class="flaticon-road-roller"></span>
									</div>
									<div class="media-body pl-4">
	...
	<section class="ftco-section ftco-counter ftco-no-pt ftco-no-pb"
		id="about-section">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 py-5 pl-md-5">
					...
					<div class="row">
						<div
							...
							<div class="block-18">
								<div class="text">
									<strong class="number" data-number="50">0</strong> <span>Years
										of Experienced</span>
								</div>
							</div>
						</div>
						<div
							...
							<div class="block-18">
								<div class="text">
									<strong class="number" data-number="4500">0</strong> <span>Customers
										Served</span>
								</div>
							</div>
						</div>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-12 text-center">
					...
					<p class="mb-0">
						<a href="#" class="btn btn-primary px-4 py-3">Make An
							Appointment</a>
					</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="services-wrap">
						<div class="img"
							style="background-image: url(/resources/images/services-1.jpg);"></div>
						<div class="text">
							<h2>Bulldozer</h2>
							<p>Far far away, behind the word mountains, far from the
				...
				<div class="col-md-3">
					<div class="services-wrap">
						<div class="img"
							style="background-image: url(/resources/images/services-2.jpg);"></div>
						<div class="text">
							<h2>Forklift</h2>
							<p>Far far away, behind the word mountains, far from the
								countries Vokalia and Consonantia</p>
				...
				<div class="col-md-3">
					<div class="services-wrap">
						<div class="img"
							style="background-image: url(/resources/images/services-3.jpg);"></div>
						<div class="text">
							<h2>Crane</h2>
							<p>Far far away, behind the word mountains, far from the
								countries Vokalia and Consonantia</p>
				...
				<div class="col-md-3">
					<div class="services-wrap">
						<div class="img"
							style="background-image: url(/resources/images/services-4.jpg);"></div>
						<div class="text">
							<h2>Excavator</h2>
							<p>Far far away, behind the word mountains, far from the
								countries Vokalia and Consonantia</p>
				...
				<div class="col-lg-4 ftco-animate">
					<div class="blog-entry">
						...
						<div class="text d-block">
							<div class="meta">
								<p>
									<a href="#"><span class="fa fa-calendar mr-2"></span>Aug.
										27, 2020</a> <a href="#"><span class="fa fa-user mr-2"></span>Admin</a>
									<a href="#" class="meta-chat"><span
										class="fa fa-comment mr-2"></span> 3</a>
								</p>
							</div>
							<h3 class="heading">
								<a href="#">New Heavy Equipment To Launch</a>
							</h3>
							<p>Far far away, behind the word mountains, far from the
								countries Vokalia and Consonantia...</p>
							<p>
			...
			<div class="row">
				<div class="col-lg col-md-6">
					<div class="ftco-footer-widget">
						<h2 class="ftco-heading-2 logo d-flex align-items-center">
							<a href="#"><span class="flaticon-road-roller flaticon"></span><span>Equipo</span></a>
						</h2>
						<p>Far far away, behind the word mountains, far from the
							countries.</p>
					...
					<div class="ftco-footer-widget">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#"><span class="fa fa-chevron-right mr-2"></span>About
									Us</a></li>
							<li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Rental
									Services</a></li>
				...
				<div class="col-lg col-md-6">
					<div class="ftco-footer-widget">
						...
						<ul class="list-unstyled">
							<li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Customer
									Services</a></li>
							<li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Prompt
									Delivery</a></li>
							<li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Reliable
									Equipment</a></li>
