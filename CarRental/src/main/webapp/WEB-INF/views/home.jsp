...
<body>
	...
	<section class="hero-wrap js-fullheight" style="background-image: url('/resources/images/bg_2.jpg');" data-stellar-background-ratio="0.5">
	...
	<section class="ftco-section">
		<div class="container-fluid px-md-4">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="services-wrap">
						<div class="img" style="background-image: url(/resources/images/services-3.jpg);"></div>
						<div class="text">
							<h2>Crane</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
						</div>
				...
				<div class="col-md-3">
					<div class="services-wrap">
						<div class="img" style="background-image: url(/resources/images/services-4.jpg);"></div>
						<div class="text">
							<h2>Excavator</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
						</div>
			...
			<div class="row">
				<div class="col-lg col-md-6">
					<div class="ftco-footer-widget">
						<h2 class="ftco-heading-2 logo d-flex align-items-center"><a href="#"><span class="flaticon-road-roller flaticon"></span><span>Equipo</span></a></h2>
